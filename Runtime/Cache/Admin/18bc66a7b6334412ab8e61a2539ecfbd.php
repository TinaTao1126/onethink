...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Order/add');?>">开单</a>
        </div>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["car_owner"]); ?> </td>
			<td><?php echo ($vo["station"]); ?></td>
			<td><?php echo ($vo["order_status_name"]); ?></td>
			<td><?php echo ($vo["pay_amount"]); ?></td>
			<td><?php echo ($vo["purchase_amount"]); ?></td>
			<td><span><?php echo (time_format($vo["createtime"])); ?></span></td>
			<td><?php echo ($vo["order_no"]); ?></td>
			<td><?php echo ($vo["operator"]); ?></td>
			<td><?php echo ($vo["driving_distance"]); ?></td>
			
			<td><?php if(vo.order_status == 100): ?><a href="<?php echo U('Order/edit?id='.$vo['id']);?>">开单</a>
				<?php elseif(vo.order_status == 200): ?>
				<a href="<?php echo U('Order/detail?id='.$vo['id']);?>" class="ajax-get">查看明细</a>
				<a href="<?php echo U('Order/settlement?id='.$vo['id']);?>" class="ajax-get">结算</a>
				<a href="<?php echo U('Order/print?id='.$vo['id']);?>" class="ajax-get">打印</a>
				<a href="<?php echo U('Order/del?id='.$vo['id']);?>">删除</a>
				</else>
				<a href="<?php echo U('Order/detail?id='.$vo['id']);?>" class="ajax-get">查看明细</a>
				<a href="<?php echo U('Order/print?id='.$vo['id']);?>" class="ajax-get">打印</a><?php endif; ?>
