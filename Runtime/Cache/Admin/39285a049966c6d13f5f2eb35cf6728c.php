...
<body>
    ...
    <form action="<?php echo U('OrderItem/add');?>" method="post" class="form-horizontal">

        <div class="form-item">
        	<input type="hidden"  name="car_order_id" value="<?php echo ($data["id"]); ?>">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea class="textarea input-large" name="item_name"></textarea>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">零件费</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item_price" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">数量</label>
            <div class="controls">
                <input type="text" class="text input-large" name="item_num" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">工时费</label>
            <div class="controls">
                <input type="text" class="text input-large" name="hour_price" value="">
            </div>
        </div>
        <div class="form-item">
