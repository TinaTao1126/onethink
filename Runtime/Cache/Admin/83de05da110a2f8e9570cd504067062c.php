...
<body>
    ...
    <form action="<?php echo U('Car/add');?>" method="post" class="form-column-2">
        ...
        <div class="form-item">
            <label class="item-label">工位号</label>
            <div class="controls">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="car_number" value="<?php echo ($data["car_number"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">车主姓名</label>
            <div class="controls">
                <input type="text" class="text input-large" name="car_owner" value="<?php echo ($data["car_owner"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">车主电话</label>
            <div class="controls">
                <input type="text" class="text input-large" name="owner_phone" value="<?php echo ($data["owner_phone"]); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="driving_distance" value="<?php echo ($data["driving_distance"]); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="car_brand" value="<?php echo ($data["car_brand"]); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="car_model" value="<?php echo ($data["car_model"]); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="car_color" value="<?php echo ($data["car_color"]); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="car_engine_num" value="<?php echo ($data["car_engine_num"]); ?>">
            </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="car_vin" value="<?php echo ($data["car_vin"]); ?>">
            </div>
            
        </div>
        <div class="form-item">
            <button class="btn submit-btn"  type="submit" target-form="form-column-2">确 定</button>
            <button class="btn btn-return" onclick="javascript:history.back(-1);return false;">返 回</button>
        </div>
    </form>
    <div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('OrderItem/add',array('id'=>$car_order_id));?>">新 增</a>
            <button class="btn ajax-post confirm" url="<?php echo U('CarItem/delete',array('method'=>'deleteStore'));?>" target-form="ids">删 除</button>
        </div>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a title="编辑" href="<?php echo U('OrderItem/edit?id='.$vo['id'].'&car_order_id='.$car_order_id);?>">编辑</a>
